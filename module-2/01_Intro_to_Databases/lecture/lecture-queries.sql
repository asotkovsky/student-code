...
SELECT city_name FROM city WHERE area < 25;
...
SELECT city_name, population FROM city WHERE area < 25 AND population > 100000;
...
SELECT state_name, census_region FROM state WHERE census_region != 'Midwest';
...
SELECT park_name, area * 100 AS area_in_square_meters FROM park;
