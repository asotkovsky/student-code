...
public class Exercises {
    ...
    public List<String> no4LetterWords(String[] stringArray) {
        ...
        for (String word : stringArray) {
            // 2) determine how many letters that word is
            if (word.length() != 4) {
...
//			// 2. Check if the number is the given number
//			if (number == intToFind) {
//				// 3. if it is the given number THEN add 1 to a count
//				count += 1;
//			}
//		}
//
//		// 4. when done checking all numbers, if the count is 2 or more then return TRUE else return FALSE
//		if (count >= 2) {
//			foundIt = true;
//		}
//
