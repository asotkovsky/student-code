...
public class Exercises {
	...
	public static void main(String[] args) {
        ...
        */
		...
		int totalPigeonsEatingBreadcrumbs = lonelyPigeonEatingBreadcrumbs + anotherPigeonEatingBreadcrumbs;
        ...
        */
		...
		int owlsJoining = 2;
		int currentTotalOwlsSittingOnFence = owlsSittingOnFence + owlsJoining;
        ...
        */
		...
		int beaversLeftWorkingOnHome = beaversWorkingOnHome - beaversGoingSwimming;
        ...
        */
		...
		int currentToucansSittingOnTreeLimb = toucansSittingOnTreeLimb + toucansJoining;
        ...
        */
		...
		double numberOfNickels = 2;
		double amountOfMoneyMrsHiltFound = (valueOfQuarter * numberOfQuarters) + (valueOfDime * numberOfDimes) + (valueOfNickels * numberOfNickels);
        ...
        */
		...
		int muffinsBakedMrsBriarClass = 18;
		int muffinsBakedMrsMacadamsClass = 20;
		int muffinsBakedMrsFlanneryClass = 17;
		int totalMuffinsBaked = muffinsBakedMrsBriarClass + muffinsBakedMrsFlanneryClass + muffinsBakedMrsMacadamsClass;
        ...
        */
		...
		int moreSnowAtMrsHiltHouse = inchesOfSnowAtMrsHiltHouse - inchesOfSnowAtBrecknockElementarySchool;
        ...
        */
		...
		double mrsHiltStartingBankBalance = 10.00;
		double moneySpentOnToyTruck = 3.00;
		double moneySpentOnPencilCase = 2.00;
		double mrsHiltEndingBankBalance = mrsHiltStartingBankBalance - moneySpentOnToyTruck - moneySpentOnPencilCase;
        ...
        */
		...
		int seashellQuantity = 19;
		int seashellGoalQuantity = 25;
		int seashellsNeededToMeetGoal = seashellGoalQuantity - seashellQuantity;
        ...
        */
		...
		int totalBooksOnShelf = existingBooksOnShelf + booksAddedToShelf;
        ...
        */
		...
		int totalBees = 8;
		int legsPerBee = 6;
		int totalBeeLegs = totalBees * legsPerBee;
        ...
        */
		...
		double costPerIceCreamCone = 0.99;
		double costofIceCreamCones = iceCreamConesPurchased * costPerIceCreamCone;
        ...
        */
		...
		int rocksNeededForGardenBorder = 125;
		int rocksAvailable = 64;
		int rocksStillNeeded = rocksNeededForGardenBorder - rocksAvailable;
        ...
        */
		...
		int totalMarblesMrsHilt = 38;
		int marblesLostMrsHilt = 15;
		int totalMarblesRemainingMrsHilt = totalMarblesMrsHilt - marblesLostMrsHilt;
        ...
        */
		...
		int milesDriven = 32;
		int milesRemaining = totalMilesToConcert - milesDriven;
        ...
        */
		...
		int minutesSpentShovelingSnowSaturday = minutesSpentShovelingSnowSaturdayAfternoon + minutesSpentShovelingSnowSaturdayMorning;
        ...
        */
		...
		double totalCostOfHotDogs = hotDogsPurchased * costPerHotDog;
        ...
        */
		...
		double mrsHiltMoney = 0.50;
		double costOfPencil = 0.07;
		int pencilsAbleToPurchase = (int)(mrsHiltMoney / costOfPencil);
        ...
        */
		...
		double changeDue = moneyPaid - costOfCandy;
        ...
        */
		...
		int numberOfExistingTrees = 13;
		int numberOfTreesPlanted = 12;
		int totalTrees = numberOfExistingTrees + numberOfTreesPlanted;
        ...
        */
		...
		int numberOfHoursUntilSeeingGrandma = numberOfDaysUntilSeeingGrandma * hoursInDay;
        ...
        */
		...
		int piecesOfGumNeeded = piecesOfGumPerCousin * numberOfCousins;
        ...
        */
		...
		double startingBalanceDan = 3.00;
		double moneySpentOnCandyBar = 1.00;
		double endingBalanceDan = startingBalanceDan - moneySpentOnCandyBar;
        ...
        */
		...
		int boatsOnLake = 5;
		int peoplePerBoat = 3;
		int peopleOnBoatsInLake = boatsOnLake * peoplePerBoat;
        ...
        */
		...
		int legosOwned = 380;
		int legosLost = 57;
		int legosRemaining = legosOwned - legosLost;
        ...
        */
		...
		int muffinsRemaining = muffinsNeeded - muffinsBaked;
        ...
        */
		...
		int numberOfMoreCrayonsOwnedByWilly = numberOfCrayonsWilly - numberOfCrayonsLucy;
        ...
        */
		...
		double numberOfCupcakes = 100.00;
